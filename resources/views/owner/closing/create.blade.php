...
@section('content')
    ...
    <div class="card">
        <form method="POST" action="{{ route('owner.closing.store') }}" class="row g-3">
            <div class="card-body">
              <a href="{{ route('owner.closing.index') }}" class="btn btn-sm btn-primary mb-3"><i class="ti ti-arrow-left"></i> Kembali</a>
                @csrf
                <div class="row mb-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="month" min="1" max="12" class="form-control"
                            value="{{ old('month', $month) }}" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="threshold_profit" class="form-control format-ribuan"
                                placeholder="Kosongkan untuk auto" data-target="threshold_profit_raw">
                            <span class="input-group-text">.00</span>
                        </div>
                        <input type="hidden" name="threshold_profit" id="threshold_profit_raw">
                    </div>
                </div>
                <div class="row">

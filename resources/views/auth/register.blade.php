            ...
            <div class="d-flex align-items-center justify-content-center w-100">
                <div class="row justify-content-center w-100">
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="{{ url('/') }}" class="text-nowrap logo-img text-center d-block mb-3 w-100">
                                    <img src="{{ asset('assets/front/img/logo/sellora-vertical.png') }}" width="280" alt="">
                                </a>
                                ...
                                <form action="{{ route('register') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" class="btn btn-primary w-100 py-8 mb-2 mt-2 rounded-2">Daftar</button>
                                </form>
